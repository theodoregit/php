<?php
    ...
    $drop1 = "alter table withdrawchemical drop id";
    $result_drop1 = mysqli_query($connection, $drop1);
    $auto1 = "alter table withdrawchemical auto_increment = 1";
    $result_auto1 = mysqli_query($connection, $auto1);
    $add1 = "alter table withdrawchemical add id int not null auto_increment primary key first";
    $result_add1 = mysqli_query($connection, $add1);

    

    // $new_amount =  $_SESSION['export_amount'];
    $query5 = "delete from withdrawchemical order by id desc limit 1";
