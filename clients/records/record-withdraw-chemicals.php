...
<?php
        ...
        $query = "select * from withdrawchemical";
        ...
        //fetch items
        $query4 = "select * from generalstorechemical where amount > 0";
        $result4 = mysqli_query($connection, $query4);

        $query5 = "select * from generalstorechemical where amount > 0";
...
<body>
        ...
        <div class="containerr">
            ...
            <form role="form" class="form-inline" action="undo-withdraw-chemical.php" method="POST">
