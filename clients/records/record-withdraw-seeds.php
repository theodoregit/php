...
<?php
        ...
        $query = "select * from withdrawseed";
        ...
        //fetch items
        $query4 = "select * from generalstoreseed where amount > 0";
        $result4 = mysqli_query($connection, $query4);

        $query5 = "select * from generalstoreseed where amount > 0";
...
<body>
        ...
        <div class="containerr">
            ...
            <form role="form" class="form-inline" action="undo-withdraw-seed.php" method="POST">
